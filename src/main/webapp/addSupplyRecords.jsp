...
<body>
<form id="formId" class="layui-form layui-form-pane" method="post">
    <span style="margin-left: 10px">供应商：</span>

    <select id="supplyId" lay-filter="supplyId" name="supply">
        <option>---请选择供应商---</option>
    </select>
    商户：
    <select id="shopId" lay-filter="shopId" name="shop">
        <option>---请选择商户---</option>
    </select>
    商品名：
    <select id="goodsId" lay-filter="goodsId" name="goods">
